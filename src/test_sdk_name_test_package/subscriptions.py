...
class Subscriptions(BaseSDK):
    ...
    def ignore_subscription_namespace(
        ...
        *,
        ...
        :param subscription_id: The existing subscription ID
        ...
        request = models.IgnoreSubscriptionNamespaceRequest(
    ...
    def activate_subscription_namespace(
        ...
        *,
        ...
        request = models.ActivateSubscriptionNamespaceRequest(
            subscription_id=subscription_id,
            namespace_name=namespace_name,
        )
