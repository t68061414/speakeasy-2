...
def get_security_from_env(security: Any, security_class: Any) -> Optional[BaseModel]:
    ...
    if os.getenv("TESTSDKNAME_API_KEY"):
        security_dict["api_key"] = os.getenv("TESTSDKNAME_API_KEY")

    if os.getenv("TESTSDKNAME_WORKSPACE_IDENTIFIER"):
        security_dict["workspace_identifier"] = os.getenv(
            "TESTSDKNAME_WORKSPACE_IDENTIFIER"
        )

    if os.getenv("TESTSDKNAME_BEARER"):
        security_dict["bearer"] = os.getenv("TESTSDKNAME_BEARER")
