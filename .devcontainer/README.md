...
```
speakeasy generate usage -s https://www.speakeasy.com/openapi.yaml -l python -i {INPUT_OPERATION_ID} -o ./samples
```

- To generate samples for an entire namespace (like a tag or group name), use:

```
speakeasy generate usage -s https://www.speakeasy.com/openapi.yaml -l python -n {INPUT_TAG_NAME} -o ./samples
```
